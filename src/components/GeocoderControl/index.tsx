...
> & {
  ...
  marker?: Object | Omit<MarkerProps, 'longitude' | 'latitude'>;

  position: ControlPosition;

  onLoading?: ((e: object) => void) | undefined;
  onResults?: ((e: object) => void) | undefined;
  onResult?: ((e: object) => void) | undefined;
  onError?: ((e: object) => void) | undefined;
};

/* eslint-disable complexity,max-statements */
export default function GeocoderControl(props: any) {
  // TODO: props should has the type 'GeocoderControlProps'
  // fix onLoading...etc function types
